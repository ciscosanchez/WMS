...
SHOPIFY_WMS_CLIENT_CODE=Ramola      # Client code to assign imported orders to
...
- Database: `ramola_wms`
- Ramola tenant schema: `tenant_armstrong`
...
### Phase 5 — NetSuite Bridge (blocked on Ramola credentials)
