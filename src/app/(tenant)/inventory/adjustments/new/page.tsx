...
const mockBins = [
  { id: "bin-01", barcode: "WH1-A-01-01-01-01" },
  { id: "bin-02", barcode: "WH1-A-01-01-01-02" },
  { id: "bin-03", barcode: "WH1-A-01-01-01-03" },
  { id: "bin-04", barcode: "WH1-B-01-01-01-01" },
  { id: "bin-05", barcode: "WH1-B-01-01-01-02" },
];
...
export default function NewAdjustmentPage() {
  ...
  function addLine() {
    ...
    const bin = mockBins.find((b) => b.id === addBinId);
