        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-2">
              <Checkbox id="freightMode" checked={freightMode} onCheckedChange={(v) => setFreightMode(!!v)} />
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="asnPrefix" value={asnPrefix} onChange={(e) => setAsnPrefix(e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="orderPrefix">Order Prefix</Label>
              <Input id="orderPrefix" value={orderPrefix} onChange={(e) => setOrderPrefix(e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="adjustmentPrefix">Adjustment Prefix</Label>
              <Input id="adjustmentPrefix" value={adjustmentPrefix} onChange={(e) => setAdjustmentPrefix(e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="pickPrefix">Pick Prefix</Label>
              <Input id="pickPrefix" value={pickPrefix} onChange={(e) => setPickPrefix(e.target.value)} />
            </div>
          </CardContent>
        </Card>
